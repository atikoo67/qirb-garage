...
class DioService {
  ...
  FutureEither<Response> get(String path,
  ...
  FutureEither<Response> post(String path,
  ...
  FutureEither<Response> put(String path,
      {dynamic data, Map<String, dynamic>? queryParameters}) {
    return runTask(
        () => AppConfig.dio
  ...
  FutureEither<Response> patch(String path,
      {dynamic data, Map<String, dynamic>? queryParameters}) {
    return runTask(
        () => AppConfig.dio
  ...
  FutureEither<Response> delete(String path,
      {dynamic data, Map<String, dynamic>? queryParameters}) {
    return runTask(
        () => AppConfig.dio
